...
public class Revista {
    ...
    private ArrayList <Artigo> saude;
    ...
    public void passaDados(String file, int i) throws IOException {
        ...
        saude = new ArrayList<Artigo>();
        for (Artigo a : artigos) {
            String x[] = a.getTemas();
            for (int j = 0; j < x.length; j++) {
                if(x[j].toLowerCase().equals("saude"))
                    saude.add(a);
            }
        }
        entrada.close();
    ...
    public void setSaude(ArrayList<Artigo> saude) {
        this.saude = saude;
    }
    ...
    public ArrayList<Artigo> getSaude() {
        return saude;
    }
